...
moduleForModel('i-i-s-upravlyayushhaya-kompaniya-база-данных-л-с', 'Unit | Serializer | i-i-s-upravlyayushhaya-kompaniya-база-данных-л-с', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-upravlyayushhaya-kompaniya-база-данных-л-с',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
