...
moduleForModel('i-i-s-upravlyayushhaya-kompaniya-организация', 'Unit | Serializer | i-i-s-upravlyayushhaya-kompaniya-организация', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-upravlyayushhaya-kompaniya-организация',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
