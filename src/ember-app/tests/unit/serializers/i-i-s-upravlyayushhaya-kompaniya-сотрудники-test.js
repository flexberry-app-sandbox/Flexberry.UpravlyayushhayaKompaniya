...
moduleForModel('i-i-s-upravlyayushhaya-kompaniya-сотрудники', 'Unit | Serializer | i-i-s-upravlyayushhaya-kompaniya-сотрудники', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-upravlyayushhaya-kompaniya-сотрудники',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
