...
moduleForModel('i-i-s-upravlyayushhaya-kompaniya-т-чквитанции', 'Unit | Serializer | i-i-s-upravlyayushhaya-kompaniya-т-чквитанции', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-upravlyayushhaya-kompaniya-т-чквитанции',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
