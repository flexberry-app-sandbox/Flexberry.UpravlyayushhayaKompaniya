...
moduleForModel('i-i-s-upravlyayushhaya-kompaniya-жилец', 'Unit | Serializer | i-i-s-upravlyayushhaya-kompaniya-жилец', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-upravlyayushhaya-kompaniya-жилец',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
