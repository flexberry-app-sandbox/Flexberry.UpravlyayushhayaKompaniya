...
moduleForModel('i-i-s-upravlyayushhaya-kompaniya-должности', 'Unit | Serializer | i-i-s-upravlyayushhaya-kompaniya-должности', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-upravlyayushhaya-kompaniya-должности',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
