...
moduleForModel('i-i-s-upravlyayushhaya-kompaniya-комму-услуги', 'Unit | Serializer | i-i-s-upravlyayushhaya-kompaniya-комму-услуги', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-upravlyayushhaya-kompaniya-комму-услуги',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
