...
moduleForModel('i-i-s-upravlyayushhaya-kompaniya-перерасчет-к-у', 'Unit | Serializer | i-i-s-upravlyayushhaya-kompaniya-перерасчет-к-у', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-upravlyayushhaya-kompaniya-перерасчет-к-у',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
