...
moduleForModel('i-i-s-upravlyayushhaya-kompaniya-квитанция', 'Unit | Serializer | i-i-s-upravlyayushhaya-kompaniya-квитанция', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-upravlyayushhaya-kompaniya-квитанция',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
