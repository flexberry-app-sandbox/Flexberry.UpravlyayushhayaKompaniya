...
moduleForAcceptance('[AGAT] Acceptance | i i s upravlyayushhaya kompaniya сотрудники l');

test('testing i-i-s-upravlyayushhaya-kompaniya-сотрудники-l', function(assert) {
