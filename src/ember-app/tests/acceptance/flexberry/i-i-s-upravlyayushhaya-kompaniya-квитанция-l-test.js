...
moduleForAcceptance('[AGAT] Acceptance | i i s upravlyayushhaya kompaniya квитанция l');

test('testing i-i-s-upravlyayushhaya-kompaniya-квитанция-l', function(assert) {
