...
moduleForAcceptance('[AGAT] Acceptance | i i s upravlyayushhaya kompaniya перерасчет к у l');

test('testing i-i-s-upravlyayushhaya-kompaniya-перерасчет-к-у-l', function(assert) {
