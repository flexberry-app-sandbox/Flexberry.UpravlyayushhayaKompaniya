...
moduleForAcceptance('[AGAT] Acceptance | i i s upravlyayushhaya kompaniya база данных л с l');

test('testing i-i-s-upravlyayushhaya-kompaniya-база-данных-л-с-l', function(assert) {
