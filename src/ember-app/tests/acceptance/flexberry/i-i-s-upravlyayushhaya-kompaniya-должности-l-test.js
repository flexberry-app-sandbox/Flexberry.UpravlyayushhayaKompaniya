...
moduleForAcceptance('[AGAT] Acceptance | i i s upravlyayushhaya kompaniya должности l');

test('testing i-i-s-upravlyayushhaya-kompaniya-должности-l', function(assert) {
